...
def test_date():
    for source,url in feeds.items():
        print(url)
        for entry in feed_extraction(url):
            print(read_rss_entry(entry,source)["date_string"])
...
for entry in feed_extraction("https://www.space.com/feeds.xml"):
    print(exclude_author(entry))